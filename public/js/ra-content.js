...
var aCubsLife = { title: "A Cub&#39;s life",
		  blocks: [
			...
			content: [ {type: "sentence", content: "A new day begins.<br/>"},
				   {type: "sentence", content: "A leopard cub wakes up.<br/>"},
				   {type: "img", src: "a-cubs-life-img-5.jpg", classes: ["img-margins"], width: 238, height: 128} ] },
		      { classes: ["zh-block", "zh-block-br"],
			content: [ {type: "sentence", content: "The cub gets a bath.<br/>"},
				   {type: "sentence", content: "Now he is ready to play.<br/>"},
				   {type: "img", src: "a-cubs-life-img-2.jpg", classes: ["img-margins"], width: 305, height: 207} ] },
		      { classes: ["zh-block", "zh-block-br"],
			content: [ {type: "sentence", content: "The cub finds a friend.<br/>"},
				   {type: "sentence", content: "The friends play in a tree.<br/>"},
